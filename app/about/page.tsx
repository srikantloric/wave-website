...
export default function AboutPage() {
  ...
  return (
    <div className="font-sans antialiased text-gray-800">
      ...
      <section className="bg-white py-12 md:py-24">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-5xl font-extrabold text-[#4a56a2] leading-tight mb-4 md:mb-6">
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="relative group w-full max-w-lg">
                ...
                <div className="absolute inset-0 bg-[#4a56a2] rounded-2xl transform transition-transform duration-500 rotate-3 opacity-20"></div>
            ...
            <div className="w-full lg:w-1/2">
              <h3 className="text-[#4a56a2] font-bold uppercase tracking-widest text-xs md:text-sm mb-2 md:mb-3">
                Our Story
              </h3>
        ...
        <div className="container mx-auto px-6 lg:px-20">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm text-center flex flex-col items-center">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-100 text-[#4a56a2] rounded-full flex items-center justify-center mb-4 md:mb-6">
      ...
      {/* ================= SECTION 5: CTA ================= */}
      <section className="py-10 md:py-10 bg-[#4a56a2] text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <Link href="/admission">
            <button className="bg-white text-[#4a56a2] px-8 py-2 md:px-8 md:py-3 rounded-full hover:bg-gray-100 transition shadow-lg font-bold text-base md:text-lg">
              Apply Now
            </button>
          </Link>
        </div>
